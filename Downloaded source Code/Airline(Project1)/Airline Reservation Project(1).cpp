...
void schedule()
{
	...
	cout << "\t\t\t\t\t\t-------------------------------------------------------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\tNumber count        Flight Name        From            To            Seats Left" << endl
		 << endl;
	cout << "\t\t\t\t\t\t<1>                 pk001              Lahore          Karachi"
		 << "\t\t" << 40 - pk1 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<2>                 pk001              Karachi         Lahore"
		 << "\t\t" << 40 - pk1 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<3>                 pk002              Lahore          Sialkot"
		 << "\t\t" << 60 - pk2 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<4>                 pk003              Sialkot         Lahore"
		 << "\t\t" << 120 - pk3 << endl
		 << endl;
	cout << "\t\t\t\t\t\t-------------------------------------------------------------------------------" << endl
		 << endl;
...
above:
	...
	cout << "\t\t\t\t\t\t\t\tNumber     Flight Name        Departure       Destination" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<1>        pk001              Lahore          Karachi" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<2>        pk001              Karachi         Lahore" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<3>        pk002              Lahore          Sialkot" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<4>        pk003              Sialkot         Lahore" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t----------------------------------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\tPress any key to continue...";
...
above1:
	...
	cout << "\t\t\t\t\t\t\t\tNumber     Seat Type        Price" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<1>        Simple Seat      50 $" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<2>        Window side      60 $" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t----------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\tPress any key to continue...";
...
void Member ::alldata()
{
	...
	else
	{
		...
		{
			cout << "\t" << m[i].id << "\t\t" << m[i].name << "\t\t" << m[i].cnic << m[i].age << "\t\t" << m[i].gender << "\t\t" << m[i].contact << "\t" << m[i].f_name << "\t\t" << m[i].depar << "\t\t\t" << m[i].desti << endl
				 << endl;
		}
		cout << "\t\t\t\t\t\t--------------------------------------------------------------------------------" << endl
			 << endl;
